const cardEvents=[
    ...
    },
    {
        ...
        cards:
            [
                ...
                },
                {
                    ...
                    body: "Verify if doodle.org is indeed used by State B for military purposes and proceed with the attack only after confirmation. We can lose advantage",
        ...
        adversaryAction: {
            ...
            security: 0,
            isLegal: false,
            body: "Inimicus’ General Pitt has threatened to attack the water filtration system of our capital city, claiming that they will contaminate the water supply, which can lead to widespread diseases and death in the civilian population. This statement is aiming to terrorise the civilian population, which goes against international law. Rule 36 prohibits cyber attacks or threats that are aimed at terrorising civilian population. We expect the international community to respond to this violation and sanction Inimicus accordingly."
        }
    },
    {
        task:{
    ...
    },
    {
        ...
        adversaryAction: {
            ...
            security: 0,
            isLegal: false,
            body: "We have received information that State B has conducted a cyber attack that affected the power supply of the main hospital where dozens of critically injured civilians were being treated on life support. State B claims that medical computer systems were used for non-humanitarian purposes, but have not provided proof. State B has also not provided warning about the loss of protection and reasonable time limit for compliance, violating Rule 73 of the Tallinn Manual on loss of protection and warning. Their illegal action has resulted in severe international sanctions from the international community crippling their economy."
        }
    }
]
